...
public class bat_move : MonoBehaviour {
	...
	void Update () 
	{
		if(master_script.talking == false && master_script.wombat_attacking == false)
		{
		...
		if(master_script.wombat_hp <= 0)
		{
			master_script.wombat_dead = true;
	...
	void OnTriggerEnter(Collider other)
	{
		...
		if(other.tag == "snake1")
		{
			master_script.snake1_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "snake2")
		{
			master_script.snake2_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "snake3")
		{
			master_script.snake3_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "snake4")
		{
			master_script.snake4_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "snake5")
		{
			master_script.snake5_attacking = 1;
			master_script.wombat_attacking = true;
		}
		...
		{
			master_script.servant1_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "servant2")
		{
			master_script.servant2_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "servant3")
		{
			master_script.servant3_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "servant4")
		{
			master_script.servant4_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "servant5")
		{
			master_script.servant5_attacking = 1;
			master_script.wombat_attacking = true;
		}
		if(other.tag == "servant6")
		{
			master_script.servant6_attacking = 1;
			master_script.wombat_attacking = true;
		}		
		if(other.tag == "servant7")
		{
			master_script.servant7_attacking = 1;
			master_script.wombat_attacking = true;
		}
	}
}
