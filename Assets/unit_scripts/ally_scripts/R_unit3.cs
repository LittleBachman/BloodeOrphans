...
public class R_unit3 : MonoBehaviour 
{
	public Vector3 click_location;
	public GameObject prefab;
	NavMeshAgent agent;
	
	public int blood_packet = 4;
	...
	void Update () 
	{
		if(master_script.talking == false && master_script.R3_attacking == false)
		{
		...
		if(master_script.R3_hp <= 0)
		{
			master_script.R3_dead = true;
	...
	void OnTriggerEnter(Collider other)
	{
		...
		if(other.tag == "snake1")
		{
			master_script.snake1_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "snake2")
		{
			master_script.snake2_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "snake3")
		{
			master_script.snake3_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "snake4")
		{
			master_script.snake4_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "snake5")
		{
			master_script.snake5_attacking = 5;
			master_script.R3_attacking = true;
		}
		...
		{
			master_script.servant1_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "servant2")
		{
			master_script.servant2_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "servant3")
		{
			master_script.servant3_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "servant4")
		{
			master_script.servant4_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "servant5")
		{
			master_script.servant5_attacking = 5;
			master_script.R3_attacking = true;
		}
		if(other.tag == "servant6")
		{
			master_script.servant6_attacking = 5;
			master_script.R3_attacking = true;
		}		
		if(other.tag == "servant7")
		{
			master_script.servant7_attacking = 5;
			master_script.R3_attacking = true;
		}
	}
}